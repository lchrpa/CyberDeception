...
(:domain caldera)
(:objects
    id_bjdomaincredential id_brdomaincredential id_pdomaincredential id_bbdomaincredential id_bfdomaincredential id_ldomaincredential id_bvdomaincredential id_hdomaincredential id_xdomaincredential id_ddomaincredential id_tdomaincredential id_bndomaincredential cred_twelve cred_thirteen cred_fourteen cred_fifteen - observeddomaincredential
    id_dorat id_durat id_dsrat id_drrat id_dqrat id_dtrat id_dvrat - observedrat
    id_cthost id_dahost id_dhhost id_byhost id_cfhost id_cmhost host_ten host_eleven - observedhost
    id_efschtask id_ehschtask id_ecschtask id_edschtask id_eeschtask id_egschtask - observedschtask
    id_gdomainuser id_bmdomainuser id_bidomainuser id_badomainuser id_bedomainuser id_budomainuser id_wdomainuser id_sdomainuser id_bqdomainuser id_cdomainuser id_kdomainuser id_odomainuser user_three - observeddomainuser
    num__87 num__53 num__74 num__88 num__81 num__66 num__60 num__67 num__73 num__80 num__52 num__59 num_eight num_nine - num
    ...
    id_adomain dom_four dom_five dom_six dom_seven - observeddomain
