...
(:domain caldera)
(:objects
    id_bjdomaincredential id_brdomaincredential id_pdomaincredential id_bbdomaincredential id_bfdomaincredential id_ldomaincredential id_bvdomaincredential id_hdomaincredential id_xdomaincredential id_ddomaincredential id_tdomaincredential id_bndomaincredential cred_sixteen cred_seventeen cred_eighteen - observeddomaincredential
    id_dorat id_durat id_dsrat id_drrat id_dqrat id_dtrat id_dvrat - observedrat
    id_cthost id_dahost id_dhhost id_byhost id_cfhost id_cmhost host_eleven host_twelve host_thirteen host_fourteen host_fifteen - observedhost
    id_efschtask id_ehschtask id_ecschtask id_edschtask id_eeschtask id_egschtask - observedschtask
    id_gdomainuser id_bmdomainuser id_bidomainuser id_badomainuser id_bedomainuser id_budomainuser id_wdomainuser id_sdomainuser id_bqdomainuser id_cdomainuser id_kdomainuser id_odomainuser user_one user_two user_three user_four user_five - observeddomainuser
    num__87 num__53 num__74 num__88 num__81 num__66 num__60 num__67 num__73 num__80 num__52 num__59 num_six num_seven num_eight num_nine num_ten - num
