...
(:domain caldera)
(:objects
    id_bjdomaincredential id_brdomaincredential id_pdomaincredential id_bbdomaincredential id_bfdomaincredential id_ldomaincredential id_bvdomaincredential id_hdomaincredential id_xdomaincredential id_ddomaincredential id_tdomaincredential id_bndomaincredential cred_three cred_four cred_five cred_six cred_seven - observeddomaincredential
    id_dorat id_durat id_dsrat id_drrat id_dqrat id_dtrat id_dvrat - observedrat
    id_cthost id_dahost id_dhhost id_byhost id_cfhost id_cmhost host_one host_two - observedhost
