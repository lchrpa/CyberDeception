...
(:objects
    ...
    id_bihost id_cdhost id_bwhost id_bphost host_eleven host_twelve host_thirteen - observedhost
    ...
    id_badomainuser id_bedomainuser id_sdomainuser id_wdomainuser id_kdomainuser id_gdomainuser id_odomainuser id_cdomainuser user_five user_six - observeddomainuser
)
(:init 
    (knows id_cdhost)
    (knows id_ckrat)
