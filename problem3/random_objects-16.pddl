...
(:domain caldera)
(:objects
    id_bfdomaincredential id_bbdomaincredential id_tdomaincredential id_xdomaincredential id_pdomaincredential id_ddomaincredential id_ldomaincredential id_hdomaincredential cred_sixteen cred_seventeen - observeddomaincredential
    id_bihost id_cdhost id_bwhost id_bphost host_fourteen host_fifteen - observedhost
    ...
    num__43 num__51 num__44 num__58 num__57 num__36 num__50 num__37 num_nine num_ten num_eleven num_twelve num_thirteen - num
    id_badomainuser id_bedomainuser id_sdomainuser id_wdomainuser id_kdomainuser id_gdomainuser id_odomainuser id_cdomainuser user_three user_four user_five user_six user_seven - observeddomainuser
)
(:init 
    (knows id_cdhost)
    (knows id_ckrat)
