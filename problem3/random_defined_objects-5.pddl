...
(:domain caldera)
(:objects
    id_bfdomaincredential id_bbdomaincredential id_tdomaincredential id_xdomaincredential id_pdomaincredential id_ddomaincredential id_ldomaincredential id_hdomaincredential cred_thirtytwo cred_thirtyfour cred_thirtysix cred_thirtyeight - observeddomaincredential
    id_bihost id_cdhost id_bwhost id_bphost host_four host_eight host_twelve host_sixteen - observedhost
    ...
    id_badomainuser id_bedomainuser id_sdomainuser id_wdomainuser id_kdomainuser id_gdomainuser id_odomainuser id_cdomainuser user_twenty user_twentythree user_twentysix user_twentynine - observeddomainuser
)
