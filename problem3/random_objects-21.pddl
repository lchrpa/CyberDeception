...
(:domain caldera)
(:objects
    id_bfdomaincredential id_bbdomaincredential id_tdomaincredential id_xdomaincredential id_pdomaincredential id_ddomaincredential id_ldomaincredential id_hdomaincredential cred_thirteen cred_fourteen cred_fifteen - observeddomaincredential
    ...
    id_badomainuser id_bedomainuser id_sdomainuser id_wdomainuser id_kdomainuser id_gdomainuser id_odomainuser id_cdomainuser user_six user_seven user_eight - observeddomainuser
)
(:init 
    (knows id_cdhost)
    (knows id_ckrat)
