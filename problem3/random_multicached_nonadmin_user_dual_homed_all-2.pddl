...
(:init (PROP_SID user_one str_three) (PROP_USERNAME user_one str_two) (PROP_IS_GROUP user_one no) (PROP_PASSWORD cred_four str_five) (PROP_WINDOWS_DOMAIN dom_six str_seven) (PROP_DNS_DOMAIN dom_six str_eight) (PROP_USER cred_four user_one) (prop_cred user_one cred_four) (PROP_DOMAIN cred_four id_adomain) (PROP_DOMAIN user_one id_adomain) (PROP_DOMAIN cred_four dom_six) (PROP_DOMAIN user_one dom_six) (MEM_CACHED_DOMAIN_CREDS id_cdhost cred_four) (mem_hosts dom_six id_cdhost) (PROP_DOMAIN id_cdhost dom_six) (MEM_CACHED_DOMAIN_CREDS id_bihost cred_four) (mem_hosts dom_six id_bihost) (PROP_DOMAIN id_bihost dom_six) (MEM_CACHED_DOMAIN_CREDS id_bwhost cred_four) (mem_hosts dom_six id_bwhost) (PROP_DOMAIN id_bwhost dom_six)
    (knows id_cdhost)
    (knows id_ckrat)
