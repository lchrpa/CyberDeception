...
(:domain caldera)
(:objects
    id_bfdomaincredential id_bbdomaincredential id_tdomaincredential id_xdomaincredential id_pdomaincredential id_ddomaincredential id_ldomaincredential id_hdomaincredential cred_thirtysix cred_thirtyeight cred_forty - observeddomaincredential
    ...
    id_badomainuser id_bedomainuser id_sdomainuser id_wdomainuser id_kdomainuser id_gdomainuser id_odomainuser id_cdomainuser user_thirtythree - observeddomainuser
)
(:init (PROP_WINDOWS_DOMAIN dom_one str_two) (PROP_DNS_DOMAIN dom_one str_three) (PROP_WINDOWS_DOMAIN dom_four str_five) (PROP_DNS_DOMAIN dom_four str_six) (PROP_WINDOWS_DOMAIN dom_seven str_eight) (PROP_DNS_DOMAIN dom_seven str_nine) (PROP_WINDOWS_DOMAIN dom_ten str_eleven) (PROP_DNS_DOMAIN dom_ten str_twelve) (PROP_DNS_DOMAIN_NAME host_thirteen str_fourteen) (PROP_FQDN host_thirteen str_fifteen) (PROP_DC host_thirteen no) (PROP_HOSTNAME host_thirteen str_sixteen) (PROP_DNS_DOMAIN_NAME host_seventeen str_eighteen) (PROP_FQDN host_seventeen str_nineteen) (PROP_DC host_seventeen no) (PROP_HOSTNAME host_seventeen str_twenty) (PROP_DNS_DOMAIN_NAME host_twentyone str_twentytwo) (PROP_FQDN host_twentyone str_twentythree) (PROP_DC host_twentyone no) (PROP_HOSTNAME host_twentyone str_twentyfour) (PROP_DNS_DOMAIN_NAME host_twentyfive str_twentysix) (PROP_FQDN host_twentyfive str_twentyseven) (PROP_DC host_twentyfive no) (PROP_HOSTNAME host_twentyfive str_twentyeight) (PROP_DNS_DOMAIN_NAME host_twentynine str_thirty) (PROP_FQDN host_twentynine str_thirtyone) (PROP_DC host_twentynine no) (PROP_HOSTNAME host_twentynine str_thirtytwo) (PROP_SID user_thirtythree str_thirtyfive) (PROP_USERNAME user_thirtythree str_thirtyfour) (PROP_IS_GROUP user_thirtythree no) (PROP_PASSWORD cred_thirtysix str_thirtyseven) (PROP_PASSWORD cred_thirtyeight str_thirtynine) (PROP_PASSWORD cred_forty str_fortyone)
    (knows id_cdhost)
    (knows id_ckrat)
