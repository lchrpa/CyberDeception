...
(:init (PROP_SID user_one str_three) (PROP_USERNAME user_one str_two) (PROP_IS_GROUP user_one no) (PROP_PASSWORD cred_four str_five) (PROP_USER cred_four user_one) (prop_cred user_one cred_four) (PROP_DOMAIN cred_four id_adomain) (PROP_DOMAIN user_one id_adomain) (MEM_CACHED_DOMAIN_CREDS id_bihost cred_four) (MEM_CACHED_DOMAIN_CREDS id_cdhost cred_four) (MEM_CACHED_DOMAIN_CREDS id_bwhost cred_four)
    (knows id_cdhost)
    (knows id_ckrat)
