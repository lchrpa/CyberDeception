...
(:objects
    ...
    id_badomainuser id_bedomainuser id_sdomainuser id_wdomainuser id_kdomainuser id_gdomainuser id_odomainuser id_cdomainuser user_four - observeddomainuser
)
(:init 
    (knows id_cdhost)
    (knows id_ckrat)
