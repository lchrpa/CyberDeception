...
(:objects
    ...
    num__43 num__51 num__44 num__58 num__57 num__36 num__50 num__37 num_eight num_nine - num
    id_badomainuser id_bedomainuser id_sdomainuser id_wdomainuser id_kdomainuser id_gdomainuser id_odomainuser id_cdomainuser user_one user_two user_three user_four user_five - observeddomainuser
)
(:init 
    (knows id_cdhost)
    (knows id_ckrat)
