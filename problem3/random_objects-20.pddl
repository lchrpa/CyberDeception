...
(:domain caldera)
(:objects
    id_bfdomaincredential id_bbdomaincredential id_tdomaincredential id_xdomaincredential id_pdomaincredential id_ddomaincredential id_ldomaincredential id_hdomaincredential cred_fifteen cred_sixteen cred_seventeen - observeddomaincredential
    id_bihost id_cdhost id_bwhost id_bphost host_ten host_eleven host_twelve host_thirteen host_fourteen - observedhost
    ...
    num__43 num__51 num__44 num__58 num__57 num__36 num__50 num__37 num_nine - num
    id_badomainuser id_bedomainuser id_sdomainuser id_wdomainuser id_kdomainuser id_gdomainuser id_odomainuser id_cdomainuser user_five user_six user_seven user_eight - observeddomainuser
)
(:init 
    (knows id_cdhost)
    (knows id_ckrat)
