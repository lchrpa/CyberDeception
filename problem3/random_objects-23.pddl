...
(:objects
    ...
    id_bihost id_cdhost id_bwhost id_bphost host_thirteen host_fourteen host_fifteen - observedhost
    id_ctschtask id_crschtask id_csschtask id_cqschtask - observedschtask
    id_dbfile id_czfile id_dafile id_cyfile - observedfile
    str__patricia str__bg str__v str__cc str__f str__bd str__u str__robert str__q str__james str__linda str__bt str__barbara str__ci str__m str__cb str__cj str__ca str__mary str__bu str__alpha str__j str__bv str__ch str__n str__z str__bh str__bm str__r str__b str__bn str__i str__bc str__michael str__john str__bo str__y str__cl str__e str_one str_two str_three - string
    ...
    num__43 num__51 num__44 num__58 num__57 num__36 num__50 num__37 num_eight num_nine num_ten num_eleven num_twelve - num
    id_badomainuser id_bedomainuser id_sdomainuser id_wdomainuser id_kdomainuser id_gdomainuser id_odomainuser id_cdomainuser user_four user_five - observeddomainuser
)
(:init 
    (knows id_cdhost)
    (knows id_ckrat)
