...
(:domain caldera)
(:objects
    wilbur_cred pris_cred rick_cred rachael_cred roy_cred john_cred cred_seventeen cred_eighteen - observeddomaincredential
    host1 host2 host3 host4 host5 host_fifteen host_sixteen - observedhost
