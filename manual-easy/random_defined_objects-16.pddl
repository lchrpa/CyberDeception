...
(:domain caldera)
(:objects
    wilbur_cred pris_cred rick_cred rachael_cred roy_cred john_cred cred_thirtynine cred_fortyone - observeddomaincredential
    host1 host2 host3 host4 host5 host_seven host_eleven host_fifteen host_nineteen host_twentythree - observedhost
    ...
    domain_str2 str_two str_three str_five str_six str_eight str_nine str_ten str_twelve str_thirteen str_fourteen str_sixteen str_seventeen str_eighteen str_twenty str_twentyone str_twentytwo str_twentyfour str_twentyfive str_twentysix str_twentyeight str_twentynine str_thirtyone str_thirtytwo str_thirtyfour str_thirtyfive str_thirtyseven str_thirtyeight str_forty str_fortytwo - string
    host1_str - string
    host2_str - string
    host3_str - string
    host4_str - string
    ...
    host4_num2 - num
    host5_num2 - num
    wilbur rick rachael roy pris john user_twentyseven user_thirty user_thirtythree user_thirtysix - observeddomainuser
)
(:init (PROP_WINDOWS_DOMAIN dom_one str_two) (PROP_DNS_DOMAIN dom_one str_three) (PROP_WINDOWS_DOMAIN dom_four str_five) (PROP_DNS_DOMAIN dom_four str_six) (PROP_DNS_DOMAIN_NAME host_seven str_eight) (PROP_FQDN host_seven str_nine) (PROP_DC host_seven no) (PROP_HOSTNAME host_seven str_ten) (PROP_DNS_DOMAIN_NAME host_eleven str_twelve) (PROP_FQDN host_eleven str_thirteen) (PROP_DC host_eleven no) (PROP_HOSTNAME host_eleven str_fourteen) (PROP_DNS_DOMAIN_NAME host_fifteen str_sixteen) (PROP_FQDN host_fifteen str_seventeen) (PROP_DC host_fifteen no) (PROP_HOSTNAME host_fifteen str_eighteen) (PROP_DNS_DOMAIN_NAME host_nineteen str_twenty) (PROP_FQDN host_nineteen str_twentyone) (PROP_DC host_nineteen no) (PROP_HOSTNAME host_nineteen str_twentytwo) (PROP_DNS_DOMAIN_NAME host_twentythree str_twentyfour) (PROP_FQDN host_twentythree str_twentyfive) (PROP_DC host_twentythree no) (PROP_HOSTNAME host_twentythree str_twentysix) (PROP_SID user_twentyseven str_twentynine) (PROP_USERNAME user_twentyseven str_twentyeight) (PROP_IS_GROUP user_twentyseven no) (PROP_SID user_thirty str_thirtytwo) (PROP_USERNAME user_thirty str_thirtyone) (PROP_IS_GROUP user_thirty no) (PROP_SID user_thirtythree str_thirtyfive) (PROP_USERNAME user_thirtythree str_thirtyfour) (PROP_IS_GROUP user_thirtythree no) (PROP_SID user_thirtysix str_thirtyeight) (PROP_USERNAME user_thirtysix str_thirtyseven) (PROP_IS_GROUP user_thirtysix no) (PROP_PASSWORD cred_thirtynine str_forty) (PROP_PASSWORD cred_fortyone str_fortytwo)
    (knows host1)
    (knows rat_host1)
