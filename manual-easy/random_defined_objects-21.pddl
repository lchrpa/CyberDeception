...
(:domain caldera)
(:objects
    wilbur_cred pris_cred rick_cred rachael_cred roy_cred john_cred cred_eighteen cred_twenty cred_twentytwo cred_twentyfour - observeddomaincredential
    host1 host2 host3 host4 host5 host_four host_eight - observedhost
    ...
    domain_str2 str_two str_three str_five str_six str_seven str_nine str_ten str_eleven str_thirteen str_fourteen str_sixteen str_seventeen str_nineteen str_twentyone str_twentythree str_twentyfive - string
    host1_str - string
    host2_str - string
    host3_str - string
    host4_str - string
    ...
    host4_num2 - num
    host5_num2 - num
    wilbur rick rachael roy pris john user_twelve user_fifteen - observeddomainuser
)
(:init (PROP_WINDOWS_DOMAIN dom_one str_two) (PROP_DNS_DOMAIN dom_one str_three) (PROP_DNS_DOMAIN_NAME host_four str_five) (PROP_FQDN host_four str_six) (PROP_DC host_four no) (PROP_HOSTNAME host_four str_seven) (PROP_DNS_DOMAIN_NAME host_eight str_nine) (PROP_FQDN host_eight str_ten) (PROP_DC host_eight no) (PROP_HOSTNAME host_eight str_eleven) (PROP_SID user_twelve str_fourteen) (PROP_USERNAME user_twelve str_thirteen) (PROP_IS_GROUP user_twelve no) (PROP_SID user_fifteen str_seventeen) (PROP_USERNAME user_fifteen str_sixteen) (PROP_IS_GROUP user_fifteen no) (PROP_PASSWORD cred_eighteen str_nineteen) (PROP_PASSWORD cred_twenty str_twentyone) (PROP_PASSWORD cred_twentytwo str_twentythree) (PROP_PASSWORD cred_twentyfour str_twentyfive)
    (knows host1)
    (knows rat_host1)
