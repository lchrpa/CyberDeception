...
(:domain caldera)
(:objects
    wilbur_cred pris_cred rick_cred rachael_cred roy_cred john_cred cred_twelve cred_thirteen cred_fourteen cred_fifteen - observeddomaincredential
    host1 host2 host3 host4 host5 host_ten host_eleven - observedhost
    ...
    rachael_name - string
    domain_str - string
    domain dom_seven - observeddomain
    ...
    host4_num2 - num
    host5_num2 - num
    wilbur rick rachael roy pris john user_five user_six - observeddomainuser
)
(:init 
    (knows host1)
    (knows rat_host1)
