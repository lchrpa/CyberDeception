...
(:domain caldera)
(:objects
    wilbur_cred pris_cred rick_cred rachael_cred roy_cred john_cred cred_sixteen cred_seventeen cred_eighteen cred_nineteen cred_twenty - observeddomaincredential
    host1 host2 host3 host4 host5 host_twelve host_thirteen host_fourteen host_fifteen - observedhost
    ...
    host1_num num_seven num_eight num_nine num_ten num_eleven - num
    host2_num - num
    host3_num - num
    host4_num - num
    host5_num - num
