...
(:init (PROP_SID user_one str_three) (PROP_USERNAME user_one str_two) (PROP_IS_GROUP user_one no) (PROP_PASSWORD cred_four str_five) (PROP_WINDOWS_DOMAIN dom_six str_seven) (PROP_DNS_DOMAIN dom_six str_eight) (PROP_USER cred_four user_one) (prop_cred user_one cred_four) (PROP_DOMAIN cred_four domain) (PROP_DOMAIN user_one domain) (PROP_DOMAIN cred_four dom_six) (PROP_DOMAIN user_one dom_six) (MEM_CACHED_DOMAIN_CREDS host1 cred_four) (mem_hosts dom_six host1) (PROP_DOMAIN host1 dom_six) (MEM_CACHED_DOMAIN_CREDS host4 cred_four) (mem_hosts dom_six host4) (PROP_DOMAIN host4 dom_six) (MEM_CACHED_DOMAIN_CREDS host2 cred_four) (mem_hosts dom_six host2) (PROP_DOMAIN host2 dom_six)
    (knows host1)
    (knows rat_host1)
