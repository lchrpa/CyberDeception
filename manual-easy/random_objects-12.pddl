...
(:domain caldera)
(:objects
    wilbur_cred pris_cred rick_cred rachael_cred roy_cred john_cred cred_fourteen cred_fifteen cred_sixteen cred_seventeen cred_eighteen - observeddomaincredential
    host1 host2 host3 host4 host5 host_eleven host_twelve host_thirteen - observedhost
    ...
    rachael_name - string
    domain_str - string
    domain dom_four dom_five - observeddomain
    ...
    host1_num num_six num_seven num_eight num_nine num_ten - num
    host2_num - num
    host3_num - num
    host4_num - num
    host5_num - num
    ...
    host4_num2 - num
    host5_num2 - num
    wilbur rick rachael roy pris john user_two user_three - observeddomainuser
)
(:init 
    (knows host1)
    (knows rat_host1)
