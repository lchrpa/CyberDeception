...
(:domain caldera)
(:objects
    wilbur_cred pris_cred rick_cred rachael_cred roy_cred john_cred cred_fortyseven cred_fortynine - observeddomaincredential
    ...
    domain_str2 str_two str_three str_five str_six str_eight str_nine str_eleven str_twelve str_fourteen str_fifteen str_seventeen str_eighteen str_nineteen str_twentyone str_twentytwo str_twentythree str_twentyfive str_twentysix str_twentyseven str_twentynine str_thirty str_thirtyone str_thirtythree str_thirtyfour str_thirtysix str_thirtyseven str_thirtynine str_forty str_fortytwo str_fortythree str_fortyfive str_fortysix str_fortyeight str_fifty - string
    host1_str - string
    host2_str - string
    host3_str - string
    host4_str - string
    ...
    host4_num2 - num
    host5_num2 - num
    wilbur rick rachael roy pris john user_thirtytwo user_thirtyfive user_thirtyeight user_fortyone user_fortyfour - observeddomainuser
)
(:init (PROP_WINDOWS_DOMAIN dom_one str_two) (PROP_DNS_DOMAIN dom_one str_three) (PROP_WINDOWS_DOMAIN dom_four str_five) (PROP_DNS_DOMAIN dom_four str_six) (PROP_WINDOWS_DOMAIN dom_seven str_eight) (PROP_DNS_DOMAIN dom_seven str_nine) (PROP_WINDOWS_DOMAIN dom_ten str_eleven) (PROP_DNS_DOMAIN dom_ten str_twelve) (PROP_WINDOWS_DOMAIN dom_thirteen str_fourteen) (PROP_DNS_DOMAIN dom_thirteen str_fifteen) (PROP_DNS_DOMAIN_NAME host_sixteen str_seventeen) (PROP_FQDN host_sixteen str_eighteen) (PROP_DC host_sixteen no) (PROP_HOSTNAME host_sixteen str_nineteen) (PROP_DNS_DOMAIN_NAME host_twenty str_twentyone) (PROP_FQDN host_twenty str_twentytwo) (PROP_DC host_twenty no) (PROP_HOSTNAME host_twenty str_twentythree) (PROP_DNS_DOMAIN_NAME host_twentyfour str_twentyfive) (PROP_FQDN host_twentyfour str_twentysix) (PROP_DC host_twentyfour no) (PROP_HOSTNAME host_twentyfour str_twentyseven) (PROP_DNS_DOMAIN_NAME host_twentyeight str_twentynine) (PROP_FQDN host_twentyeight str_thirty) (PROP_DC host_twentyeight no) (PROP_HOSTNAME host_twentyeight str_thirtyone) (PROP_SID user_thirtytwo str_thirtyfour) (PROP_USERNAME user_thirtytwo str_thirtythree) (PROP_IS_GROUP user_thirtytwo no) (PROP_SID user_thirtyfive str_thirtyseven) (PROP_USERNAME user_thirtyfive str_thirtysix) (PROP_IS_GROUP user_thirtyfive no) (PROP_SID user_thirtyeight str_forty) (PROP_USERNAME user_thirtyeight str_thirtynine) (PROP_IS_GROUP user_thirtyeight no) (PROP_SID user_fortyone str_fortythree) (PROP_USERNAME user_fortyone str_fortytwo) (PROP_IS_GROUP user_fortyone no) (PROP_SID user_fortyfour str_fortysix) (PROP_USERNAME user_fortyfour str_fortyfive) (PROP_IS_GROUP user_fortyfour no) (PROP_PASSWORD cred_fortyseven str_fortyeight) (PROP_PASSWORD cred_fortynine str_fifty)
    (knows host1)
    (knows rat_host1)
