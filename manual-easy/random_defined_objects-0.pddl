...
(:domain caldera)
(:objects
    wilbur_cred pris_cred rick_cred rachael_cred roy_cred john_cred cred_twentyseven cred_twentynine cred_thirtyone cred_thirtythree - observeddomaincredential
    host1 host2 host3 host4 host5 host_seven host_eleven - observedhost
    ...
    domain_str2 str_two str_three str_five str_six str_eight str_nine str_ten str_twelve str_thirteen str_fourteen str_sixteen str_seventeen str_nineteen str_twenty str_twentytwo str_twentythree str_twentyfive str_twentysix str_twentyeight str_thirty str_thirtytwo str_thirtyfour - string
    host1_str - string
    host2_str - string
    host3_str - string
    host4_str - string
