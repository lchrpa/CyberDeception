...
(:domain caldera)
(:objects
    wilbur_cred pris_cred rick_cred rachael_cred roy_cred john_cred cred_thirtynine cred_fortyone cred_fortythree cred_fortyfive - observeddomaincredential
    host1 host2 host3 host4 host5 host_thirteen host_seventeen host_twentyone host_twentyfive host_twentynine - observedhost
    ...
    domain_str2 str_two str_three str_five str_six str_eight str_nine str_eleven str_twelve str_fourteen str_fifteen str_sixteen str_eighteen str_nineteen str_twenty str_twentytwo str_twentythree str_twentyfour str_twentysix str_twentyseven str_twentyeight str_thirty str_thirtyone str_thirtytwo str_thirtyfour str_thirtyfive str_thirtyseven str_thirtyeight str_forty str_fortytwo str_fortyfour str_fortysix - string
    host1_str - string
    host2_str - string
    host3_str - string
    host4_str - string
    ...
    host4_num2 - num
    host5_num2 - num
    wilbur rick rachael roy pris john user_thirtythree user_thirtysix - observeddomainuser
)
(:init (PROP_WINDOWS_DOMAIN dom_one str_two) (PROP_DNS_DOMAIN dom_one str_three) (PROP_WINDOWS_DOMAIN dom_four str_five) (PROP_DNS_DOMAIN dom_four str_six) (PROP_WINDOWS_DOMAIN dom_seven str_eight) (PROP_DNS_DOMAIN dom_seven str_nine) (PROP_WINDOWS_DOMAIN dom_ten str_eleven) (PROP_DNS_DOMAIN dom_ten str_twelve) (PROP_DNS_DOMAIN_NAME host_thirteen str_fourteen) (PROP_FQDN host_thirteen str_fifteen) (PROP_DC host_thirteen no) (PROP_HOSTNAME host_thirteen str_sixteen) (PROP_DNS_DOMAIN_NAME host_seventeen str_eighteen) (PROP_FQDN host_seventeen str_nineteen) (PROP_DC host_seventeen no) (PROP_HOSTNAME host_seventeen str_twenty) (PROP_DNS_DOMAIN_NAME host_twentyone str_twentytwo) (PROP_FQDN host_twentyone str_twentythree) (PROP_DC host_twentyone no) (PROP_HOSTNAME host_twentyone str_twentyfour) (PROP_DNS_DOMAIN_NAME host_twentyfive str_twentysix) (PROP_FQDN host_twentyfive str_twentyseven) (PROP_DC host_twentyfive no) (PROP_HOSTNAME host_twentyfive str_twentyeight) (PROP_DNS_DOMAIN_NAME host_twentynine str_thirty) (PROP_FQDN host_twentynine str_thirtyone) (PROP_DC host_twentynine no) (PROP_HOSTNAME host_twentynine str_thirtytwo) (PROP_SID user_thirtythree str_thirtyfive) (PROP_USERNAME user_thirtythree str_thirtyfour) (PROP_IS_GROUP user_thirtythree no) (PROP_SID user_thirtysix str_thirtyeight) (PROP_USERNAME user_thirtysix str_thirtyseven) (PROP_IS_GROUP user_thirtysix no) (PROP_PASSWORD cred_thirtynine str_forty) (PROP_PASSWORD cred_fortyone str_fortytwo) (PROP_PASSWORD cred_fortythree str_fortyfour) (PROP_PASSWORD cred_fortyfive str_fortysix)
    (knows host1)
    (knows rat_host1)
