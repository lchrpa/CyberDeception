...
(:domain caldera)
(:objects
    wilbur_cred pris_cred rick_cred rachael_cred roy_cred john_cred cred_twentytwo cred_twentyfour cred_twentysix - observeddomaincredential
    host1 host2 host3 host4 host5 host_four host_eight host_twelve - observedhost
    ...
    domain_str2 str_two str_three str_five str_six str_seven str_nine str_ten str_eleven str_thirteen str_fourteen str_fifteen str_seventeen str_eighteen str_twenty str_twentyone str_twentythree str_twentyfive str_twentyseven - string
    host1_str - string
    host2_str - string
    host3_str - string
    host4_str - string
    ...
    host4_num2 - num
    host5_num2 - num
    wilbur rick rachael roy pris john user_sixteen user_nineteen - observeddomainuser
)
(:init (PROP_WINDOWS_DOMAIN dom_one str_two) (PROP_DNS_DOMAIN dom_one str_three) (PROP_DNS_DOMAIN_NAME host_four str_five) (PROP_FQDN host_four str_six) (PROP_DC host_four no) (PROP_HOSTNAME host_four str_seven) (PROP_DNS_DOMAIN_NAME host_eight str_nine) (PROP_FQDN host_eight str_ten) (PROP_DC host_eight no) (PROP_HOSTNAME host_eight str_eleven) (PROP_DNS_DOMAIN_NAME host_twelve str_thirteen) (PROP_FQDN host_twelve str_fourteen) (PROP_DC host_twelve no) (PROP_HOSTNAME host_twelve str_fifteen) (PROP_SID user_sixteen str_eighteen) (PROP_USERNAME user_sixteen str_seventeen) (PROP_IS_GROUP user_sixteen no) (PROP_SID user_nineteen str_twentyone) (PROP_USERNAME user_nineteen str_twenty) (PROP_IS_GROUP user_nineteen no) (PROP_PASSWORD cred_twentytwo str_twentythree) (PROP_PASSWORD cred_twentyfour str_twentyfive) (PROP_PASSWORD cred_twentysix str_twentyseven)
    (knows host1)
    (knows rat_host1)
