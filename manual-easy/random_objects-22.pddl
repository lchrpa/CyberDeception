...
(:domain caldera)
(:objects
    wilbur_cred pris_cred rick_cred rachael_cred roy_cred john_cred cred_fifteen cred_sixteen cred_seventeen cred_eighteen cred_nineteen - observeddomaincredential
    ...
    rachael_name - string
    domain_str - string
    domain dom_nine - observeddomain
    ...
    host4_num2 - num
    host5_num2 - num
    wilbur rick rachael roy pris john user_five user_six user_seven user_eight - observeddomainuser
)
(:init 
    (knows host1)
    (knows rat_host1)
