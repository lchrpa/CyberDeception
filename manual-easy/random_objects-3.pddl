...
(:objects
    ...
    rachael_name - string
    domain_str - string
    domain dom_ten dom_eleven dom_twelve dom_thirteen - observeddomain
    ...
    host4_num2 - num
    host5_num2 - num
    wilbur rick rachael roy pris john user_six user_seven user_eight user_nine - observeddomainuser
)
(:init 
    (knows host1)
    (knows rat_host1)
