...
(:domain caldera)
(:objects
    wilbur_cred pris_cred rick_cred rachael_cred roy_cred john_cred cred_fifteen cred_sixteen cred_seventeen - observeddomaincredential
    ...
    rachael_name - string
    domain_str - string
    domain dom_six dom_seven dom_eight dom_nine - observeddomain
