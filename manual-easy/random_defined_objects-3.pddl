...
(:domain caldera)
(:objects
    wilbur_cred pris_cred rick_cred rachael_cred roy_cred john_cred cred_twentyfour cred_twentysix cred_twentyeight cred_thirty - observeddomaincredential
    ...
    domain_str2 str_two str_three str_five str_six str_eight str_nine str_ten str_twelve str_thirteen str_fourteen str_sixteen str_seventeen str_nineteen str_twenty str_twentytwo str_twentythree str_twentyfive str_twentyseven str_twentynine str_thirtyone - string
    host1_str - string
    host2_str - string
    host3_str - string
    host4_str - string
    ...
    host4_num2 - num
    host5_num2 - num
    wilbur rick rachael roy pris john user_fifteen user_eighteen user_twentyone - observeddomainuser
)
