...
(:domain caldera)
(:objects
    wilbur_cred pris_cred rick_cred rachael_cred roy_cred john_cred cred_eight cred_nine cred_ten cred_eleven - observeddomaincredential
    ...
    rachael_name - string
    domain_str - string
    domain dom_four - observeddomain
    ...
    host4_num2 - num
    host5_num2 - num
    wilbur rick rachael roy pris john user_three - observeddomainuser
)
(:init 
    (knows host1)
    (knows rat_host1)
