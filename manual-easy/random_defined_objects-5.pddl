...
(:domain caldera)
(:objects
    wilbur_cred pris_cred rick_cred rachael_cred roy_cred john_cred cred_thirtysix cred_thirtyeight cred_forty cred_fortytwo cred_fortyfour - observeddomaincredential
    host1 host2 host3 host4 host5 host_sixteen host_twenty - observedhost
