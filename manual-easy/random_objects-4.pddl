...
(:objects
    ...
    host1 host2 host3 host4 host5 host_fifteen - observedhost
    ...
    rachael_name - string
    domain_str - string
    domain dom_seven dom_eight dom_nine - observeddomain
    ...
    host4_num2 - num
    host5_num2 - num
    wilbur rick rachael roy pris john user_four user_five user_six - observeddomainuser
)
(:init 
    (knows host1)
    (knows rat_host1)
