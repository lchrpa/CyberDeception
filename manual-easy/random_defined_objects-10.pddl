...
(:domain caldera)
(:objects
    wilbur_cred pris_cred rick_cred rachael_cred roy_cred john_cred cred_thirtyfour cred_thirtysix - observeddomaincredential
    host1 host2 host3 host4 host5 host_ten host_fourteen host_eighteen - observedhost
