...
(:domain caldera)
(:objects
    wilbur_cred pris_cred rick_cred rachael_cred roy_cred john_cred cred_seven cred_eight cred_nine cred_ten cred_eleven - observeddomaincredential
    host1 host2 host3 host4 host5 host_five host_six - observedhost
