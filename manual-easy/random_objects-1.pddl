...
(:domain caldera)
(:objects
    wilbur_cred pris_cred rick_cred rachael_cred roy_cred john_cred cred_nineteen - observeddomaincredential
    ...
    host4_num2 - num
    host5_num2 - num
    wilbur rick rachael roy pris john user_two user_three user_four user_five - observeddomainuser
)
(:init 
    (knows host1)
    (knows rat_host1)
