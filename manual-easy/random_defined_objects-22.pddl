...
(:domain caldera)
(:objects
    wilbur_cred pris_cred rick_cred rachael_cred roy_cred john_cred cred_twentysix cred_twentyeight - observeddomaincredential
    host1 host2 host3 host4 host5 host_seven - observedhost
    ...
    domain_str2 str_two str_three str_five str_six str_eight str_nine str_ten str_twelve str_thirteen str_fifteen str_sixteen str_eighteen str_nineteen str_twentyone str_twentytwo str_twentyfour str_twentyfive str_twentyseven str_twentynine - string
    host1_str - string
    host2_str - string
    host3_str - string
    host4_str - string
    ...
    host4_num2 - num
    host5_num2 - num
    wilbur rick rachael roy pris john user_eleven user_fourteen user_seventeen user_twenty user_twentythree - observeddomainuser
)
(:init (PROP_WINDOWS_DOMAIN dom_one str_two) (PROP_DNS_DOMAIN dom_one str_three) (PROP_WINDOWS_DOMAIN dom_four str_five) (PROP_DNS_DOMAIN dom_four str_six) (PROP_DNS_DOMAIN_NAME host_seven str_eight) (PROP_FQDN host_seven str_nine) (PROP_DC host_seven no) (PROP_HOSTNAME host_seven str_ten) (PROP_SID user_eleven str_thirteen) (PROP_USERNAME user_eleven str_twelve) (PROP_IS_GROUP user_eleven no) (PROP_SID user_fourteen str_sixteen) (PROP_USERNAME user_fourteen str_fifteen) (PROP_IS_GROUP user_fourteen no) (PROP_SID user_seventeen str_nineteen) (PROP_USERNAME user_seventeen str_eighteen) (PROP_IS_GROUP user_seventeen no) (PROP_SID user_twenty str_twentytwo) (PROP_USERNAME user_twenty str_twentyone) (PROP_IS_GROUP user_twenty no) (PROP_SID user_twentythree str_twentyfive) (PROP_USERNAME user_twentythree str_twentyfour) (PROP_IS_GROUP user_twentythree no) (PROP_PASSWORD cred_twentysix str_twentyseven) (PROP_PASSWORD cred_twentyeight str_twentynine)
    (knows host1)
    (knows rat_host1)
