...
(:domain caldera)
(:objects
    wilbur_cred pris_cred rick_cred rachael_cred roy_cred john_cred cred_fourteen cred_sixteen cred_eighteen cred_twenty - observeddomaincredential
    ...
    domain_str2 str_two str_three str_five str_six str_eight str_nine str_ten str_twelve str_thirteen str_fifteen str_seventeen str_nineteen str_twentyone - string
    host1_str - string
    host2_str - string
    host3_str - string
    host4_str - string
...
(:init (PROP_WINDOWS_DOMAIN dom_one str_two) (PROP_DNS_DOMAIN dom_one str_three) (PROP_WINDOWS_DOMAIN dom_four str_five) (PROP_DNS_DOMAIN dom_four str_six) (PROP_DNS_DOMAIN_NAME host_seven str_eight) (PROP_FQDN host_seven str_nine) (PROP_DC host_seven no) (PROP_HOSTNAME host_seven str_ten) (PROP_SID user_eleven str_thirteen) (PROP_USERNAME user_eleven str_twelve) (PROP_IS_GROUP user_eleven no) (PROP_PASSWORD cred_fourteen str_fifteen) (PROP_PASSWORD cred_sixteen str_seventeen) (PROP_PASSWORD cred_eighteen str_nineteen) (PROP_PASSWORD cred_twenty str_twentyone)
    (knows host1)
    (knows rat_host1)
