...
(:domain caldera)
(:objects
    wilbur_cred pris_cred rick_cred rachael_cred roy_cred john_cred cred_twelve cred_thirteen cred_fourteen - observeddomaincredential
    ...
    host4_num2 - num
    host5_num2 - num
    wilbur rick rachael roy pris john user_four user_five user_six user_seven - observeddomainuser
)
(:init 
    (knows host1)
    (knows rat_host1)
