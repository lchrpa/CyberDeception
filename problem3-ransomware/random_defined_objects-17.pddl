...
(:domain caldera)
(:objects
    id_bfdomaincredential id_bbdomaincredential id_tdomaincredential id_xdomaincredential id_pdomaincredential id_ddomaincredential id_ldomaincredential id_hdomaincredential cred_thirtynine cred_fortyone cred_fortythree - observeddomaincredential
    id_bihost id_cdhost id_bwhost id_bphost host_seven host_eleven host_fifteen host_nineteen host_twentythree - observedhost
    id_ctschtask id_crschtask id_csschtask id_cqschtask - observedschtask
    id_dbfile id_czfile id_dafile id_cyfile - observedfile
    str__patricia str__bg str__v str__cc str__f str__bd str__u str__robert str__q str__james str__linda str__bt str__barbara str__ci str__m str__cb str__cj str__ca str__mary str__bu str__alpha str__j str__bv str__ch str__n str__z str__bh str__bm str__r str__b str__bn str__i str__bc str__michael str__john str__bo str__y str__cl str__e str_two str_three str_five str_six str_eight str_nine str_ten str_twelve str_thirteen str_fourteen str_sixteen str_seventeen str_eighteen str_twenty str_twentyone str_twentytwo str_twentyfour str_twentyfive str_twentysix str_twentyeight str_twentynine str_thirtyone str_thirtytwo str_thirtyfour str_thirtyfive str_thirtyseven str_thirtyeight str_forty str_fortytwo str_fortyfour - string
