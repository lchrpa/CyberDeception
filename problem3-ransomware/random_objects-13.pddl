...
(:domain caldera)
(:objects
    id_bfdomaincredential id_bbdomaincredential id_tdomaincredential id_xdomaincredential id_pdomaincredential id_ddomaincredential id_ldomaincredential id_hdomaincredential cred_fourteen - observeddomaincredential
    id_bihost id_cdhost id_bwhost id_bphost host_ten host_eleven host_twelve host_thirteen - observedhost
    ...
    id_badomainuser id_bedomainuser id_sdomainuser id_wdomainuser id_kdomainuser id_gdomainuser id_odomainuser id_cdomainuser user_two user_three user_four user_five user_six - observeddomainuser
)
(:init 
