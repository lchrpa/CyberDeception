...
(:domain caldera)
(:objects
    id_bfdomaincredential id_bbdomaincredential id_tdomaincredential id_xdomaincredential id_pdomaincredential id_ddomaincredential id_ldomaincredential id_hdomaincredential cred_twelve cred_thirteen cred_fourteen cred_fifteen - observeddomaincredential
    id_bihost id_cdhost id_bwhost id_bphost host_eleven - observedhost
    ...
    num__43 num__51 num__44 num__58 num__57 num__36 num__50 num__37 num_ten - num
    id_badomainuser id_bedomainuser id_sdomainuser id_wdomainuser id_kdomainuser id_gdomainuser id_odomainuser id_cdomainuser user_six user_seven user_eight user_nine - observeddomainuser
)
(:init 
