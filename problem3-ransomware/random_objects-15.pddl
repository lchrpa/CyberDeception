...
(:domain caldera)
(:objects
    id_bfdomaincredential id_bbdomaincredential id_tdomaincredential id_xdomaincredential id_pdomaincredential id_ddomaincredential id_ldomaincredential id_hdomaincredential cred_nine cred_ten cred_eleven cred_twelve - observeddomaincredential
    id_bihost id_cdhost id_bwhost id_bphost host_seven host_eight - observedhost
    ...
    num__43 num__51 num__44 num__58 num__57 num__36 num__50 num__37 num_six - num
    id_badomainuser id_bedomainuser id_sdomainuser id_wdomainuser id_kdomainuser id_gdomainuser id_odomainuser id_cdomainuser user_five - observeddomainuser
)
(:init 
