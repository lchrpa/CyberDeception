...
(:domain caldera)
(:objects
    id_bfdomaincredential id_bbdomaincredential id_tdomaincredential id_xdomaincredential id_pdomaincredential id_ddomaincredential id_ldomaincredential id_hdomaincredential cred_thirtyeight cred_forty cred_fortytwo - observeddomaincredential
    id_bihost id_cdhost id_bwhost id_bphost host_seven host_eleven host_fifteen host_nineteen - observedhost
    id_ctschtask id_crschtask id_csschtask id_cqschtask - observedschtask
    id_dbfile id_czfile id_dafile id_cyfile - observedfile
    str__patricia str__bg str__v str__cc str__f str__bd str__u str__robert str__q str__james str__linda str__bt str__barbara str__ci str__m str__cb str__cj str__ca str__mary str__bu str__alpha str__j str__bv str__ch str__n str__z str__bh str__bm str__r str__b str__bn str__i str__bc str__michael str__john str__bo str__y str__cl str__e str_two str_three str_five str_six str_eight str_nine str_ten str_twelve str_thirteen str_fourteen str_sixteen str_seventeen str_eighteen str_twenty str_twentyone str_twentytwo str_twentyfour str_twentyfive str_twentyseven str_twentyeight str_thirty str_thirtyone str_thirtythree str_thirtyfour str_thirtysix str_thirtyseven str_thirtynine str_fortyone str_fortythree - string
    ...
    id_badomainuser id_bedomainuser id_sdomainuser id_wdomainuser id_kdomainuser id_gdomainuser id_odomainuser id_cdomainuser user_twentythree user_twentysix user_twentynine user_thirtytwo user_thirtyfive - observeddomainuser
)
