...
(:domain caldera)
(:objects
    id_bfdomaincredential id_bbdomaincredential id_tdomaincredential id_xdomaincredential id_pdomaincredential id_ddomaincredential id_ldomaincredential id_hdomaincredential cred_twentyeight cred_thirty cred_thirtytwo cred_thirtyfour - observeddomaincredential
    id_bihost id_cdhost id_bwhost id_bphost host_four host_eight host_twelve - observedhost
    id_ctschtask id_crschtask id_csschtask id_cqschtask - observedschtask
    id_dbfile id_czfile id_dafile id_cyfile - observedfile
    str__patricia str__bg str__v str__cc str__f str__bd str__u str__robert str__q str__james str__linda str__bt str__barbara str__ci str__m str__cb str__cj str__ca str__mary str__bu str__alpha str__j str__bv str__ch str__n str__z str__bh str__bm str__r str__b str__bn str__i str__bc str__michael str__john str__bo str__y str__cl str__e str_two str_three str_five str_six str_seven str_nine str_ten str_eleven str_thirteen str_fourteen str_fifteen str_seventeen str_eighteen str_twenty str_twentyone str_twentythree str_twentyfour str_twentysix str_twentyseven str_twentynine str_thirtyone str_thirtythree str_thirtyfive - string
    ...
    id_badomainuser id_bedomainuser id_sdomainuser id_wdomainuser id_kdomainuser id_gdomainuser id_odomainuser id_cdomainuser user_sixteen user_nineteen user_twentytwo user_twentyfive - observeddomainuser
)
(:init (PROP_WINDOWS_DOMAIN dom_one str_two) (PROP_DNS_DOMAIN dom_one str_three) (PROP_DNS_DOMAIN_NAME host_four str_five) (PROP_FQDN host_four str_six) (PROP_DC host_four no) (PROP_HOSTNAME host_four str_seven) (PROP_DNS_DOMAIN_NAME host_eight str_nine) (PROP_FQDN host_eight str_ten) (PROP_DC host_eight no) (PROP_HOSTNAME host_eight str_eleven) (PROP_DNS_DOMAIN_NAME host_twelve str_thirteen) (PROP_FQDN host_twelve str_fourteen) (PROP_DC host_twelve no) (PROP_HOSTNAME host_twelve str_fifteen) (PROP_SID user_sixteen str_eighteen) (PROP_USERNAME user_sixteen str_seventeen) (PROP_IS_GROUP user_sixteen no) (PROP_SID user_nineteen str_twentyone) (PROP_USERNAME user_nineteen str_twenty) (PROP_IS_GROUP user_nineteen no) (PROP_SID user_twentytwo str_twentyfour) (PROP_USERNAME user_twentytwo str_twentythree) (PROP_IS_GROUP user_twentytwo no) (PROP_SID user_twentyfive str_twentyseven) (PROP_USERNAME user_twentyfive str_twentysix) (PROP_IS_GROUP user_twentyfive no) (PROP_PASSWORD cred_twentyeight str_twentynine) (PROP_PASSWORD cred_thirty str_thirtyone) (PROP_PASSWORD cred_thirtytwo str_thirtythree) (PROP_PASSWORD cred_thirtyfour str_thirtyfive)
