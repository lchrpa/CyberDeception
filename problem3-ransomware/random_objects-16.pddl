...
(:domain caldera)
(:objects
    id_bfdomaincredential id_bbdomaincredential id_tdomaincredential id_xdomaincredential id_pdomaincredential id_ddomaincredential id_ldomaincredential id_hdomaincredential cred_fifteen cred_sixteen cred_seventeen cred_eighteen - observeddomaincredential
    id_bihost id_cdhost id_bwhost id_bphost host_thirteen host_fourteen - observedhost
    ...
    id_adomain dom_four dom_five dom_six dom_seven dom_eight - observeddomain
    ...
    num__43 num__51 num__44 num__58 num__57 num__36 num__50 num__37 num_nine num_ten num_eleven num_twelve - num
    id_badomainuser id_bedomainuser id_sdomainuser id_wdomainuser id_kdomainuser id_gdomainuser id_odomainuser id_cdomainuser user_two user_three - observeddomainuser
)
(:init 
