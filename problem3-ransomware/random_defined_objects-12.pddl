...
(:domain caldera)
(:objects
    id_bfdomaincredential id_bbdomaincredential id_tdomaincredential id_xdomaincredential id_pdomaincredential id_ddomaincredential id_ldomaincredential id_hdomaincredential cred_fifteen - observeddomaincredential
    ...
    id_badomainuser id_bedomainuser id_sdomainuser id_wdomainuser id_kdomainuser id_gdomainuser id_odomainuser id_cdomainuser user_twelve - observeddomainuser
)
(:init (PROP_WINDOWS_DOMAIN dom_one str_two) (PROP_DNS_DOMAIN dom_one str_three) (PROP_DNS_DOMAIN_NAME host_four str_five) (PROP_FQDN host_four str_six) (PROP_DC host_four no) (PROP_HOSTNAME host_four str_seven) (PROP_DNS_DOMAIN_NAME host_eight str_nine) (PROP_FQDN host_eight str_ten) (PROP_DC host_eight no) (PROP_HOSTNAME host_eight str_eleven) (PROP_SID user_twelve str_fourteen) (PROP_USERNAME user_twelve str_thirteen) (PROP_IS_GROUP user_twelve no) (PROP_PASSWORD cred_fifteen str_sixteen)
