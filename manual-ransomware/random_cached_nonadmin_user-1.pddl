...
(:init (PROP_SID user_one str_three) (PROP_USERNAME user_one str_two) (PROP_IS_GROUP user_one no) (PROP_PASSWORD cred_four str_five) (PROP_USER cred_four user_one) (prop_cred user_one cred_four) (PROP_DOMAIN cred_four domain) (PROP_DOMAIN user_one domain) (MEM_CACHED_DOMAIN_CREDS host3 cred_four)
    (not (ransomed host1))
    (not (ransomed host2))
    (not (ransomed host3))
    (not (ransomed host4))
