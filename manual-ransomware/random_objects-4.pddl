...
(:domain caldera)
(:objects
    wilbur_cred roy_cred pris_cred rick_cred rachael_cred john_cred cred_twentyone cred_twentytwo cred_twentythree cred_twentyfour cred_twentyfive - observeddomaincredential
    host1 host2 host3 host4 host5 host_seventeen host_eighteen host_nineteen host_twenty - observedhost
    ...
    domain_str2 str_one str_two str_three str_four - string
    host1_str - string
    host2_str - string
    host3_str - string
    host4_str - string
    ...
    rachael_name - string
    domain_str - string
    domain dom_ten dom_eleven dom_twelve - observeddomain
    ...
    host1_num num_thirteen num_fourteen num_fifteen num_sixteen - num
    host2_num - num
    host3_num - num
    host4_num - num
    host5_num - num
    ...
    host4_num2 - num
    host5_num2 - num
    wilbur rick rachael roy pris john user_five user_six user_seven user_eight user_nine - observeddomainuser
)
(:init 
    (not (ransomed host1))
    (not (ransomed host2))
