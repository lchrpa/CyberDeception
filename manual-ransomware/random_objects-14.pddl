...
(:domain caldera)
(:objects
    wilbur_cred roy_cred pris_cred rick_cred rachael_cred john_cred cred_fifteen - observeddomaincredential
    host1 host2 host3 host4 host5 host_ten host_eleven host_twelve host_thirteen host_fourteen - observedhost
    ...
    rachael_name - string
    domain_str - string
    domain dom_five dom_six dom_seven - observeddomain
    ...
    host1_num num_eight num_nine - num
    host2_num - num
    host3_num - num
    host4_num - num
    host5_num - num
