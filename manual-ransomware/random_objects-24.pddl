...
(:domain caldera)
(:objects
    wilbur_cred roy_cred pris_cred rick_cred rachael_cred john_cred cred_seven cred_eight cred_nine - observeddomaincredential
    host1 host2 host3 host4 host5 host_six - observedhost
    ...
    rachael_name - string
    domain_str - string
    domain dom_five - observeddomain
    ...
    host4_num2 - num
    host5_num2 - num
    wilbur rick rachael roy pris john user_four - observeddomainuser
)
(:init 
    (not (ransomed host1))
    (not (ransomed host2))
