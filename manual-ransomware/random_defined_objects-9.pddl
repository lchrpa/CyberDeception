...
(:domain caldera)
(:objects
    wilbur_cred roy_cred pris_cred rick_cred rachael_cred john_cred cred_thirtysix - observeddomaincredential
    host1 host2 host3 host4 host5 host_ten host_fourteen host_eighteen host_twentytwo host_twentysix - observedhost
