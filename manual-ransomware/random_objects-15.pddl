...
(:domain caldera)
(:objects
    wilbur_cred roy_cred pris_cred rick_cred rachael_cred john_cred cred_ten cred_eleven cred_twelve - observeddomaincredential
    host1 host2 host3 host4 host5 host_seven host_eight host_nine - observedhost
    ...
    host1_num num_two num_three num_four num_five num_six - num
    host2_num - num
    host3_num - num
    host4_num - num
    host5_num - num
