...
(:domain caldera)
(:objects
    wilbur_cred roy_cred pris_cred rick_cred rachael_cred john_cred cred_sixteen - observeddomaincredential
    host1 host2 host3 host4 host5 host_thirteen host_fourteen host_fifteen - observedhost
    ...
    rachael_name - string
    domain_str - string
    domain dom_six dom_seven dom_eight - observeddomain
    ...
    host1_num num_nine num_ten num_eleven num_twelve - num
    host2_num - num
    host3_num - num
    host4_num - num
    host5_num - num
    ...
    host4_num2 - num
    host5_num2 - num
    wilbur rick rachael roy pris john user_four user_five - observeddomainuser
)
(:init 
    (not (ransomed host1))
    (not (ransomed host2))
