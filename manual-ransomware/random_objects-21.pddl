...
(:domain caldera)
(:objects
    wilbur_cred roy_cred pris_cred rick_cred rachael_cred john_cred cred_seventeen cred_eighteen cred_nineteen - observeddomaincredential
    ...
    domain_str2 str_one str_two str_three - string
    host1_str - string
    host2_str - string
    host3_str - string
    host4_str - string
    ...
    rachael_name - string
    domain_str - string
    domain dom_nine dom_ten dom_eleven - observeddomain
    ...
    host1_num num_twelve num_thirteen num_fourteen num_fifteen num_sixteen - num
    host2_num - num
    host3_num - num
    host4_num - num
    host5_num - num
    ...
    host4_num2 - num
    host5_num2 - num
    wilbur rick rachael roy pris john user_four user_five user_six user_seven user_eight - observeddomainuser
)
(:init 
    (not (ransomed host1))
    (not (ransomed host2))
