...
(:domain caldera)
(:objects
    wilbur_cred roy_cred pris_cred rick_cred rachael_cred john_cred cred_twelve cred_thirteen cred_fourteen cred_fifteen cred_sixteen - observeddomaincredential
    host1 host2 host3 host4 host5 host_seven host_eight host_nine host_ten host_eleven - observedhost
    ...
    rachael_name - string
    domain_str - string
    domain dom_one dom_two dom_three - observeddomain
    ...
    host1_num num_four num_five num_six - num
    host2_num - num
    host3_num - num
    host4_num - num
    host5_num - num
