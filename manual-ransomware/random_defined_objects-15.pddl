...
(:domain caldera)
(:objects
    wilbur_cred roy_cred pris_cred rick_cred rachael_cred john_cred cred_thirtyeight cred_forty cred_fortytwo cred_fortyfour - observeddomaincredential
    host1 host2 host3 host4 host5 host_seven host_eleven host_fifteen host_nineteen - observedhost
    ...
    domain_str2 str_two str_three str_five str_six str_eight str_nine str_ten str_twelve str_thirteen str_fourteen str_sixteen str_seventeen str_eighteen str_twenty str_twentyone str_twentytwo str_twentyfour str_twentyfive str_twentyseven str_twentyeight str_thirty str_thirtyone str_thirtythree str_thirtyfour str_thirtysix str_thirtyseven str_thirtynine str_fortyone str_fortythree str_fortyfive - string
    host1_str - string
    host2_str - string
    host3_str - string
    host4_str - string
    ...
    rachael_name - string
    domain_str - string
    domain dom_one dom_four - observeddomain
    ...
    host4_num2 - num
    host5_num2 - num
    wilbur rick rachael roy pris john user_twentythree user_twentysix user_twentynine user_thirtytwo user_thirtyfive - observeddomainuser
)
(:init (PROP_WINDOWS_DOMAIN dom_one str_two) (PROP_DNS_DOMAIN dom_one str_three) (PROP_WINDOWS_DOMAIN dom_four str_five) (PROP_DNS_DOMAIN dom_four str_six) (PROP_DNS_DOMAIN_NAME host_seven str_eight) (PROP_FQDN host_seven str_nine) (PROP_DC host_seven no) (PROP_HOSTNAME host_seven str_ten) (PROP_DNS_DOMAIN_NAME host_eleven str_twelve) (PROP_FQDN host_eleven str_thirteen) (PROP_DC host_eleven no) (PROP_HOSTNAME host_eleven str_fourteen) (PROP_DNS_DOMAIN_NAME host_fifteen str_sixteen) (PROP_FQDN host_fifteen str_seventeen) (PROP_DC host_fifteen no) (PROP_HOSTNAME host_fifteen str_eighteen) (PROP_DNS_DOMAIN_NAME host_nineteen str_twenty) (PROP_FQDN host_nineteen str_twentyone) (PROP_DC host_nineteen no) (PROP_HOSTNAME host_nineteen str_twentytwo) (PROP_SID user_twentythree str_twentyfive) (PROP_USERNAME user_twentythree str_twentyfour) (PROP_IS_GROUP user_twentythree no) (PROP_SID user_twentysix str_twentyeight) (PROP_USERNAME user_twentysix str_twentyseven) (PROP_IS_GROUP user_twentysix no) (PROP_SID user_twentynine str_thirtyone) (PROP_USERNAME user_twentynine str_thirty) (PROP_IS_GROUP user_twentynine no) (PROP_SID user_thirtytwo str_thirtyfour) (PROP_USERNAME user_thirtytwo str_thirtythree) (PROP_IS_GROUP user_thirtytwo no) (PROP_SID user_thirtyfive str_thirtyseven) (PROP_USERNAME user_thirtyfive str_thirtysix) (PROP_IS_GROUP user_thirtyfive no) (PROP_PASSWORD cred_thirtyeight str_thirtynine) (PROP_PASSWORD cred_forty str_fortyone) (PROP_PASSWORD cred_fortytwo str_fortythree) (PROP_PASSWORD cred_fortyfour str_fortyfive)
    (not (ransomed host1))
    (not (ransomed host2))
    (not (ransomed host3))
    (not (ransomed host4))
