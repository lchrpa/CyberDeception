...
(:objects
    ...
    host1 host2 host3 host4 host5 host_one - observedhost
    ...
    domain_str2 str_two str_three str_four - string
    host1_str - string
    host2_str - string
    host3_str - string
    host4_str - string
...
(:init (PROP_DNS_DOMAIN_NAME host_one str_two) (PROP_FQDN host_one str_three) (PROP_DC host_one no) (PROP_HOSTNAME host_one str_four)
    (not (ransomed host1))
    (not (ransomed host2))
    (not (ransomed host3))
    (not (ransomed host4))
