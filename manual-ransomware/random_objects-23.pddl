...
(:domain caldera)
(:objects
    wilbur_cred roy_cred pris_cred rick_cred rachael_cred john_cred cred_thirteen cred_fourteen cred_fifteen cred_sixteen cred_seventeen - observeddomaincredential
    host1 host2 host3 host4 host5 host_eleven host_twelve - observedhost
    ...
    rachael_name - string
    domain_str - string
    domain dom_three dom_four dom_five dom_six - observeddomain
    ...
    host1_num num_seven num_eight num_nine num_ten - num
    host2_num - num
    host3_num - num
    host4_num - num
    host5_num - num
    ...
    host4_num2 - num
    host5_num2 - num
    wilbur rick rachael roy pris john user_one user_two - observeddomainuser
)
(:init 
    (not (ransomed host1))
    (not (ransomed host2))
