...
(:domain caldera)
(:objects
    wilbur_cred roy_cred pris_cred rick_cred rachael_cred john_cred cred_eleven - observeddomaincredential
    ...
    domain_str2 str_two str_three str_five str_six str_seven str_nine str_ten str_twelve - string
    host1_str - string
    host2_str - string
    host3_str - string
    host4_str - string
    ...
    host4_num2 - num
    host5_num2 - num
    wilbur rick rachael roy pris john user_eight - observeddomainuser
)
(:init (PROP_WINDOWS_DOMAIN dom_one str_two) (PROP_DNS_DOMAIN dom_one str_three) (PROP_DNS_DOMAIN_NAME host_four str_five) (PROP_FQDN host_four str_six) (PROP_DC host_four no) (PROP_HOSTNAME host_four str_seven) (PROP_SID user_eight str_ten) (PROP_USERNAME user_eight str_nine) (PROP_IS_GROUP user_eight no) (PROP_PASSWORD cred_eleven str_twelve) (mem_hosts dom_one host_four) (PROP_DOMAIN host_four dom_one) (PROP_DOMAIN user_eight dom_one) (PROP_DOMAIN cred_eleven dom_one) (MEM_CACHED_DOMAIN_CREDS host_four cred_eleven) (MEM_DOMAIN_USER_ADMINS host_four user_eight) (PROP_USER cred_eleven user_eight) (prop_cred user_eight cred_eleven)
    (not (ransomed host1))
    (not (ransomed host2))
    (not (ransomed host3))
    (not (ransomed host4))
