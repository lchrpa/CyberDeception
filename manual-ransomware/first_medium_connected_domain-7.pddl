...
(:domain caldera)
(:objects
    wilbur_cred roy_cred pris_cred rick_cred rachael_cred john_cred cred_eleven cred_twenty cred_twentynine - observeddomaincredential
    host1 host2 host3 host4 host5 host_four host_thirteen host_twentytwo - observedhost
    host1_schtask - observedschtask
    host2_schtask - observedschtask
    host3_schtask - observedschtask
    host4_schtask - observedschtask
    host5_schtask - observedschtask
    host1_file - observedfile
    host2_file - observedfile
    host3_file - observedfile
    host4_file - observedfile
    host5_file - observedfile
    domain_str2 str_two str_three str_five str_six str_seven str_nine str_ten str_twelve str_fourteen str_fifteen str_sixteen str_eighteen str_nineteen str_twentyone str_twentythree str_twentyfour str_twentyfive str_twentyseven str_twentyeight str_thirty - string
    host1_str - string
    host2_str - string
    host3_str - string
    host4_str - string
    ...
    host4_num2 - num
    host5_num2 - num
    wilbur rick rachael roy pris john user_eight user_seventeen user_twentysix - observeddomainuser
)
(:init (PROP_WINDOWS_DOMAIN dom_one str_two) (PROP_DNS_DOMAIN dom_one str_three) (PROP_DNS_DOMAIN_NAME host_four str_five) (PROP_FQDN host_four str_six) (PROP_DC host_four no) (PROP_HOSTNAME host_four str_seven) (PROP_SID user_eight str_ten) (PROP_USERNAME user_eight str_nine) (PROP_IS_GROUP user_eight no) (PROP_PASSWORD cred_eleven str_twelve) (PROP_DNS_DOMAIN_NAME host_thirteen str_fourteen) (PROP_FQDN host_thirteen str_fifteen) (PROP_DC host_thirteen no) (PROP_HOSTNAME host_thirteen str_sixteen) (PROP_SID user_seventeen str_nineteen) (PROP_USERNAME user_seventeen str_eighteen) (PROP_IS_GROUP user_seventeen no) (PROP_PASSWORD cred_twenty str_twentyone) (PROP_DNS_DOMAIN_NAME host_twentytwo str_twentythree) (PROP_FQDN host_twentytwo str_twentyfour) (PROP_DC host_twentytwo no) (PROP_HOSTNAME host_twentytwo str_twentyfive) (PROP_SID user_twentysix str_twentyeight) (PROP_USERNAME user_twentysix str_twentyseven) (PROP_IS_GROUP user_twentysix no) (PROP_PASSWORD cred_twentynine str_thirty) (mem_hosts dom_one host_four) (PROP_DOMAIN host_four dom_one) (mem_hosts dom_one host_thirteen) (PROP_DOMAIN host_thirteen dom_one) (mem_hosts dom_one host_twentytwo) (PROP_DOMAIN host_twentytwo dom_one) (PROP_DOMAIN cred_eleven dom_one) (PROP_DOMAIN cred_twenty dom_one) (PROP_DOMAIN cred_twentynine dom_one) (PROP_DOMAIN user_eight dom_one) (PROP_DOMAIN user_seventeen dom_one) (PROP_DOMAIN user_twentysix dom_one) (PROP_USER cred_eleven user_eight) (prop_cred user_eight cred_eleven) (MEM_CACHED_DOMAIN_CREDS host_four cred_eleven) (MEM_DOMAIN_USER_ADMINS host_thirteen user_eight) (PROP_USER cred_twenty user_seventeen) (prop_cred user_seventeen cred_twenty) (MEM_CACHED_DOMAIN_CREDS host_thirteen cred_twenty) (MEM_DOMAIN_USER_ADMINS host_twentytwo user_seventeen) (PROP_USER cred_twentynine user_twentysix) (prop_cred user_twentysix cred_twentynine) (MEM_CACHED_DOMAIN_CREDS host_twentytwo cred_twentynine) (MEM_DOMAIN_USER_ADMINS host_four user_twentysix) (MEM_DOMAIN_USER_ADMINS host_four rachael)
    (not (ransomed host1))
    (not (ransomed host2))
    (not (ransomed host3))
    (not (ransomed host4))
