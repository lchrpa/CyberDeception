...
(:objects
    ...
    domain_str2 str_two str_three str_five - string
    host1_str - string
    host2_str - string
    host3_str - string
    host4_str - string
