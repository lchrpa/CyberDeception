...
(:domain caldera)
(:objects
    wilbur_cred roy_cred pris_cred rick_cred rachael_cred john_cred cred_eleven cred_twelve cred_thirteen cred_fourteen - observeddomaincredential
    ...
    domain_str2 str_one str_two str_three str_four str_five - string
    host1_str - string
    host2_str - string
    host3_str - string
    host4_str - string
    ...
    host1_num num_nine num_ten - num
    host2_num - num
    host3_num - num
    host4_num - num
    host5_num - num
    ...
    host4_num2 - num
    host5_num2 - num
    wilbur rick rachael roy pris john user_six user_seven user_eight - observeddomainuser
)
(:init 
    (not (ransomed host1))
    (not (ransomed host2))
