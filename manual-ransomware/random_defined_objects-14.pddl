...
(:domain caldera)
(:objects
    wilbur_cred roy_cred pris_cred rick_cred rachael_cred john_cred cred_thirtytwo cred_thirtyfour cred_thirtysix cred_thirtyeight cred_forty - observeddomaincredential
    host1 host2 host3 host4 host5 host_ten host_fourteen host_eighteen host_twentytwo - observedhost
    ...
    domain_str2 str_two str_three str_five str_six str_eight str_nine str_eleven str_twelve str_thirteen str_fifteen str_sixteen str_seventeen str_nineteen str_twenty str_twentyone str_twentythree str_twentyfour str_twentyfive str_twentyseven str_twentyeight str_thirty str_thirtyone str_thirtythree str_thirtyfive str_thirtyseven str_thirtynine str_fortyone - string
    host1_str - string
    host2_str - string
    host3_str - string
    host4_str - string
    ...
    rachael_name - string
    domain_str - string
    domain dom_one dom_four dom_seven - observeddomain
    ...
    host4_num2 - num
    host5_num2 - num
    wilbur rick rachael roy pris john user_twentysix user_twentynine - observeddomainuser
)
(:init (PROP_WINDOWS_DOMAIN dom_one str_two) (PROP_DNS_DOMAIN dom_one str_three) (PROP_WINDOWS_DOMAIN dom_four str_five) (PROP_DNS_DOMAIN dom_four str_six) (PROP_WINDOWS_DOMAIN dom_seven str_eight) (PROP_DNS_DOMAIN dom_seven str_nine) (PROP_DNS_DOMAIN_NAME host_ten str_eleven) (PROP_FQDN host_ten str_twelve) (PROP_DC host_ten no) (PROP_HOSTNAME host_ten str_thirteen) (PROP_DNS_DOMAIN_NAME host_fourteen str_fifteen) (PROP_FQDN host_fourteen str_sixteen) (PROP_DC host_fourteen no) (PROP_HOSTNAME host_fourteen str_seventeen) (PROP_DNS_DOMAIN_NAME host_eighteen str_nineteen) (PROP_FQDN host_eighteen str_twenty) (PROP_DC host_eighteen no) (PROP_HOSTNAME host_eighteen str_twentyone) (PROP_DNS_DOMAIN_NAME host_twentytwo str_twentythree) (PROP_FQDN host_twentytwo str_twentyfour) (PROP_DC host_twentytwo no) (PROP_HOSTNAME host_twentytwo str_twentyfive) (PROP_SID user_twentysix str_twentyeight) (PROP_USERNAME user_twentysix str_twentyseven) (PROP_IS_GROUP user_twentysix no) (PROP_SID user_twentynine str_thirtyone) (PROP_USERNAME user_twentynine str_thirty) (PROP_IS_GROUP user_twentynine no) (PROP_PASSWORD cred_thirtytwo str_thirtythree) (PROP_PASSWORD cred_thirtyfour str_thirtyfive) (PROP_PASSWORD cred_thirtysix str_thirtyseven) (PROP_PASSWORD cred_thirtyeight str_thirtynine) (PROP_PASSWORD cred_forty str_fortyone)
    (not (ransomed host1))
    (not (ransomed host2))
    (not (ransomed host3))
    (not (ransomed host4))
