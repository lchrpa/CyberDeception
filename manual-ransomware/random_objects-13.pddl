...
(:domain caldera)
(:objects
    wilbur_cred roy_cred pris_cred rick_cred rachael_cred john_cred cred_eight cred_nine cred_ten cred_eleven cred_twelve - observeddomaincredential
    host1 host2 host3 host4 host5 host_six host_seven - observedhost
    ...
    rachael_name - string
    domain_str - string
    domain dom_three dom_four - observeddomain
