...
(:objects
    ...
    host1 host2 host3 host4 host5 host_fourteen host_fifteen host_sixteen host_seventeen host_eighteen - observedhost
    ...
    rachael_name - string
    domain_str - string
    domain dom_five dom_six dom_seven dom_eight - observeddomain
    ...
    host1_num num_nine num_ten num_eleven num_twelve num_thirteen - num
    host2_num - num
    host3_num - num
    host4_num - num
    host5_num - num
    ...
    host4_num2 - num
    host5_num2 - num
    wilbur rick rachael roy pris john user_one user_two user_three user_four - observeddomainuser
)
(:init 
    (not (ransomed host1))
    (not (ransomed host2))
