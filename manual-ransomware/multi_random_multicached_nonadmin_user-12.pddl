...
(:domain caldera)
(:objects
    wilbur_cred roy_cred pris_cred rick_cred rachael_cred john_cred cred_four cred_nine cred_fourteen - observeddomaincredential
    ...
    domain_str2 str_two str_three str_five str_seven str_eight str_ten str_twelve str_thirteen str_fifteen - string
    host1_str - string
    host2_str - string
    host3_str - string
    host4_str - string
    ...
    host4_num2 - num
    host5_num2 - num
    wilbur rick rachael roy pris john user_one user_six user_eleven - observeddomainuser
)
(:init (PROP_SID user_one str_three) (PROP_USERNAME user_one str_two) (PROP_IS_GROUP user_one no) (PROP_PASSWORD cred_four str_five) (PROP_USER cred_four user_one) (prop_cred user_one cred_four) (PROP_DOMAIN cred_four domain) (PROP_DOMAIN user_one domain) (MEM_CACHED_DOMAIN_CREDS host1 cred_four) (MEM_CACHED_DOMAIN_CREDS host2 cred_four) (MEM_CACHED_DOMAIN_CREDS host5 cred_four) (PROP_SID user_six str_eight) (PROP_USERNAME user_six str_seven) (PROP_IS_GROUP user_six no) (PROP_PASSWORD cred_nine str_ten) (PROP_USER cred_four user_one) (prop_cred user_one cred_four) (PROP_DOMAIN cred_four domain) (PROP_DOMAIN user_one domain) (MEM_CACHED_DOMAIN_CREDS host5 cred_four) (MEM_CACHED_DOMAIN_CREDS host4 cred_four) (MEM_CACHED_DOMAIN_CREDS host3 cred_four) (PROP_SID user_eleven str_thirteen) (PROP_USERNAME user_eleven str_twelve) (PROP_IS_GROUP user_eleven no) (PROP_PASSWORD cred_fourteen str_fifteen) (PROP_USER cred_four user_one) (prop_cred user_one cred_four) (PROP_DOMAIN cred_four domain) (PROP_DOMAIN user_one domain) (MEM_CACHED_DOMAIN_CREDS host2 cred_four) (MEM_CACHED_DOMAIN_CREDS host4 cred_four) (MEM_CACHED_DOMAIN_CREDS host1 cred_four)
    (not (ransomed host1))
    (not (ransomed host2))
    (not (ransomed host3))
    (not (ransomed host4))
