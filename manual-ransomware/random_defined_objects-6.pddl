...
(:domain caldera)
(:objects
    wilbur_cred roy_cred pris_cred rick_cred rachael_cred john_cred cred_twentyfour cred_twentysix cred_twentyeight cred_thirty - observeddomaincredential
    host1 host2 host3 host4 host5 host_ten host_fourteen - observedhost
    ...
    domain_str2 str_two str_three str_five str_six str_eight str_nine str_eleven str_twelve str_thirteen str_fifteen str_sixteen str_seventeen str_nineteen str_twenty str_twentytwo str_twentythree str_twentyfive str_twentyseven str_twentynine str_thirtyone - string
    host1_str - string
    host2_str - string
    host3_str - string
    host4_str - string
    ...
    host4_num2 - num
    host5_num2 - num
    wilbur rick rachael roy pris john user_eighteen user_twentyone - observeddomainuser
)
(:init (PROP_WINDOWS_DOMAIN dom_one str_two) (PROP_DNS_DOMAIN dom_one str_three) (PROP_WINDOWS_DOMAIN dom_four str_five) (PROP_DNS_DOMAIN dom_four str_six) (PROP_WINDOWS_DOMAIN dom_seven str_eight) (PROP_DNS_DOMAIN dom_seven str_nine) (PROP_DNS_DOMAIN_NAME host_ten str_eleven) (PROP_FQDN host_ten str_twelve) (PROP_DC host_ten no) (PROP_HOSTNAME host_ten str_thirteen) (PROP_DNS_DOMAIN_NAME host_fourteen str_fifteen) (PROP_FQDN host_fourteen str_sixteen) (PROP_DC host_fourteen no) (PROP_HOSTNAME host_fourteen str_seventeen) (PROP_SID user_eighteen str_twenty) (PROP_USERNAME user_eighteen str_nineteen) (PROP_IS_GROUP user_eighteen no) (PROP_SID user_twentyone str_twentythree) (PROP_USERNAME user_twentyone str_twentytwo) (PROP_IS_GROUP user_twentyone no) (PROP_PASSWORD cred_twentyfour str_twentyfive) (PROP_PASSWORD cred_twentysix str_twentyseven) (PROP_PASSWORD cred_twentyeight str_twentynine) (PROP_PASSWORD cred_thirty str_thirtyone)
    (not (ransomed host1))
    (not (ransomed host2))
    (not (ransomed host3))
    (not (ransomed host4))
