...
(:domain caldera)
(:objects
    wilbur_cred roy_cred pris_cred rick_cred rachael_cred john_cred cred_fortyone - observeddomaincredential
    host1 host2 host3 host4 host5 host_thirteen host_seventeen host_twentyone host_twentyfive - observedhost
    ...
    domain_str2 str_two str_three str_five str_six str_eight str_nine str_eleven str_twelve str_fourteen str_fifteen str_sixteen str_eighteen str_nineteen str_twenty str_twentytwo str_twentythree str_twentyfour str_twentysix str_twentyseven str_twentyeight str_thirty str_thirtyone str_thirtythree str_thirtyfour str_thirtysix str_thirtyseven str_thirtynine str_forty str_fortytwo - string
    host1_str - string
    host2_str - string
    host3_str - string
    host4_str - string
    ...
    rachael_name - string
    domain_str - string
    domain dom_one dom_four dom_seven dom_ten - observeddomain
    ...
    host4_num2 - num
    host5_num2 - num
    wilbur rick rachael roy pris john user_twentynine user_thirtytwo user_thirtyfive user_thirtyeight - observeddomainuser
)
(:init (PROP_WINDOWS_DOMAIN dom_one str_two) (PROP_DNS_DOMAIN dom_one str_three) (PROP_WINDOWS_DOMAIN dom_four str_five) (PROP_DNS_DOMAIN dom_four str_six) (PROP_WINDOWS_DOMAIN dom_seven str_eight) (PROP_DNS_DOMAIN dom_seven str_nine) (PROP_WINDOWS_DOMAIN dom_ten str_eleven) (PROP_DNS_DOMAIN dom_ten str_twelve) (PROP_DNS_DOMAIN_NAME host_thirteen str_fourteen) (PROP_FQDN host_thirteen str_fifteen) (PROP_DC host_thirteen no) (PROP_HOSTNAME host_thirteen str_sixteen) (PROP_DNS_DOMAIN_NAME host_seventeen str_eighteen) (PROP_FQDN host_seventeen str_nineteen) (PROP_DC host_seventeen no) (PROP_HOSTNAME host_seventeen str_twenty) (PROP_DNS_DOMAIN_NAME host_twentyone str_twentytwo) (PROP_FQDN host_twentyone str_twentythree) (PROP_DC host_twentyone no) (PROP_HOSTNAME host_twentyone str_twentyfour) (PROP_DNS_DOMAIN_NAME host_twentyfive str_twentysix) (PROP_FQDN host_twentyfive str_twentyseven) (PROP_DC host_twentyfive no) (PROP_HOSTNAME host_twentyfive str_twentyeight) (PROP_SID user_twentynine str_thirtyone) (PROP_USERNAME user_twentynine str_thirty) (PROP_IS_GROUP user_twentynine no) (PROP_SID user_thirtytwo str_thirtyfour) (PROP_USERNAME user_thirtytwo str_thirtythree) (PROP_IS_GROUP user_thirtytwo no) (PROP_SID user_thirtyfive str_thirtyseven) (PROP_USERNAME user_thirtyfive str_thirtysix) (PROP_IS_GROUP user_thirtyfive no) (PROP_SID user_thirtyeight str_forty) (PROP_USERNAME user_thirtyeight str_thirtynine) (PROP_IS_GROUP user_thirtyeight no) (PROP_PASSWORD cred_fortyone str_fortytwo)
    (not (ransomed host1))
    (not (ransomed host2))
    (not (ransomed host3))
    (not (ransomed host4))
