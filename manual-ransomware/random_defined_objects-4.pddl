...
(:domain caldera)
(:objects
    wilbur_cred roy_cred pris_cred rick_cred rachael_cred john_cred cred_thirtyfive cred_thirtyseven cred_thirtynine - observeddomaincredential
    ...
    domain_str2 str_two str_three str_five str_six str_eight str_nine str_eleven str_twelve str_fourteen str_fifteen str_seventeen str_eighteen str_nineteen str_twentyone str_twentytwo str_twentythree str_twentyfive str_twentysix str_twentyseven str_twentynine str_thirty str_thirtyone str_thirtythree str_thirtyfour str_thirtysix str_thirtyeight str_forty - string
    host1_str - string
    host2_str - string
    host3_str - string
    host4_str - string
