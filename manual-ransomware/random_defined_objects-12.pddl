...
(:domain caldera)
(:objects
    wilbur_cred roy_cred pris_cred rick_cred rachael_cred john_cred cred_twentyfive cred_twentyseven cred_twentynine - observeddomaincredential
    ...
    domain_str2 str_two str_three str_five str_six str_eight str_nine str_eleven str_twelve str_thirteen str_fifteen str_sixteen str_seventeen str_nineteen str_twenty str_twentyone str_twentythree str_twentyfour str_twentysix str_twentyeight str_thirty - string
    host1_str - string
    host2_str - string
    host3_str - string
    host4_str - string
