...
(:domain caldera)
(:objects
    wilbur_cred roy_cred pris_cred rick_cred rachael_cred john_cred cred_thirtyfour cred_thirtysix - observeddomaincredential
    host1 host2 host3 host4 host5 host_thirteen host_seventeen host_twentyone - observedhost
