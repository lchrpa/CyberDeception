...
(:domain caldera)
(:objects
    wilbur_cred roy_cred pris_cred rick_cred rachael_cred john_cred cred_eight cred_nine cred_ten - observeddomaincredential
    ...
    rachael_name - string
    domain_str - string
    domain dom_three - observeddomain
    ...
    host4_num2 - num
    host5_num2 - num
    wilbur rick rachael roy pris john user_two - observeddomainuser
)
(:init 
    (not (ransomed host1))
    (not (ransomed host2))
