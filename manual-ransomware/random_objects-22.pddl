...
(:domain caldera)
(:objects
    wilbur_cred roy_cred pris_cred rick_cred rachael_cred john_cred cred_thirteen cred_fourteen - observeddomaincredential
    ...
    rachael_name - string
    domain_str - string
    domain dom_three dom_four dom_five - observeddomain
    ...
    host1_num num_six num_seven num_eight - num
    host2_num - num
    host3_num - num
    host4_num - num
    host5_num - num
