...
(:objects
    ...
    host1 host2 host3 host4 host5 host_eight host_nine host_ten host_eleven - observedhost
    ...
    rachael_name - string
    domain_str - string
    domain dom_three dom_four dom_five dom_six dom_seven - observeddomain
