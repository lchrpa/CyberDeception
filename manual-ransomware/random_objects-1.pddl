...
(:domain caldera)
(:objects
    wilbur_cred roy_cred pris_cred rick_cred rachael_cred john_cred cred_thirteen cred_fourteen cred_fifteen - observeddomaincredential
    host1 host2 host3 host4 host5 host_nine host_ten host_eleven host_twelve - observedhost
    ...
    domain_str2 str_one str_two - string
    host1_str - string
    host2_str - string
    host3_str - string
    host4_str - string
    ...
    host4_num2 - num
    host5_num2 - num
    wilbur rick rachael roy pris john user_three user_four user_five - observeddomainuser
)
(:init 
    (not (ransomed host1))
    (not (ransomed host2))
