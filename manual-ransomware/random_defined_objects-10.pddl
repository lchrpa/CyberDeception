...
(:domain caldera)
(:objects
    wilbur_cred roy_cred pris_cred rick_cred rachael_cred john_cred cred_thirtyfour cred_thirtysix cred_thirtyeight cred_forty - observeddomaincredential
    host1 host2 host3 host4 host5 host_seven host_eleven host_fifteen - observedhost
    ...
    domain_str2 str_two str_three str_five str_six str_eight str_nine str_ten str_twelve str_thirteen str_fourteen str_sixteen str_seventeen str_eighteen str_twenty str_twentyone str_twentythree str_twentyfour str_twentysix str_twentyseven str_twentynine str_thirty str_thirtytwo str_thirtythree str_thirtyfive str_thirtyseven str_thirtynine str_fortyone - string
    host1_str - string
    host2_str - string
    host3_str - string
    host4_str - string
    ...
    host4_num2 - num
    host5_num2 - num
    wilbur rick rachael roy pris john user_nineteen user_twentytwo user_twentyfive user_twentyeight user_thirtyone - observeddomainuser
)
(:init (PROP_WINDOWS_DOMAIN dom_one str_two) (PROP_DNS_DOMAIN dom_one str_three) (PROP_WINDOWS_DOMAIN dom_four str_five) (PROP_DNS_DOMAIN dom_four str_six) (PROP_DNS_DOMAIN_NAME host_seven str_eight) (PROP_FQDN host_seven str_nine) (PROP_DC host_seven no) (PROP_HOSTNAME host_seven str_ten) (PROP_DNS_DOMAIN_NAME host_eleven str_twelve) (PROP_FQDN host_eleven str_thirteen) (PROP_DC host_eleven no) (PROP_HOSTNAME host_eleven str_fourteen) (PROP_DNS_DOMAIN_NAME host_fifteen str_sixteen) (PROP_FQDN host_fifteen str_seventeen) (PROP_DC host_fifteen no) (PROP_HOSTNAME host_fifteen str_eighteen) (PROP_SID user_nineteen str_twentyone) (PROP_USERNAME user_nineteen str_twenty) (PROP_IS_GROUP user_nineteen no) (PROP_SID user_twentytwo str_twentyfour) (PROP_USERNAME user_twentytwo str_twentythree) (PROP_IS_GROUP user_twentytwo no) (PROP_SID user_twentyfive str_twentyseven) (PROP_USERNAME user_twentyfive str_twentysix) (PROP_IS_GROUP user_twentyfive no) (PROP_SID user_twentyeight str_thirty) (PROP_USERNAME user_twentyeight str_twentynine) (PROP_IS_GROUP user_twentyeight no) (PROP_SID user_thirtyone str_thirtythree) (PROP_USERNAME user_thirtyone str_thirtytwo) (PROP_IS_GROUP user_thirtyone no) (PROP_PASSWORD cred_thirtyfour str_thirtyfive) (PROP_PASSWORD cred_thirtysix str_thirtyseven) (PROP_PASSWORD cred_thirtyeight str_thirtynine) (PROP_PASSWORD cred_forty str_fortyone)
    (not (ransomed host1))
    (not (ransomed host2))
    (not (ransomed host3))
    (not (ransomed host4))
