...
(:domain caldera)
(:objects
    wilbur_cred roy_cred pris_cred rick_cred rachael_cred john_cred cred_thirteen - observeddomaincredential
    host1 host2 host3 host4 host5 host_twelve - observedhost
    ...
    host1_num num_ten num_eleven - num
    host2_num - num
    host3_num - num
    host4_num - num
    host5_num - num
    ...
    host4_num2 - num
    host5_num2 - num
    wilbur rick rachael roy pris john user_three user_four user_five user_six user_seven - observeddomainuser
)
(:init 
    (not (ransomed host1))
    (not (ransomed host2))
