...
(:domain caldera)
(:objects
    id_bjdomaincredential id_brdomaincredential id_pdomaincredential id_bbdomaincredential id_bfdomaincredential id_ldomaincredential id_bvdomaincredential id_hdomaincredential id_xdomaincredential id_ddomaincredential id_tdomaincredential id_bndomaincredential cred_twentysix cred_twentyeight cred_thirty cred_thirtytwo cred_thirtyfour - observeddomaincredential
    id_dorat id_durat id_dsrat id_drrat id_dqrat id_dtrat id_dvrat - observedrat
    id_cthost id_dahost id_dhhost id_byhost id_cfhost id_cmhost host_seven - observedhost
    id_efschtask id_ehschtask id_ecschtask id_edschtask id_eeschtask id_egschtask - observedschtask
    id_gdomainuser id_bmdomainuser id_bidomainuser id_badomainuser id_bedomainuser id_budomainuser id_wdomainuser id_sdomainuser id_bqdomainuser id_cdomainuser id_kdomainuser id_odomainuser user_eleven user_fourteen user_seventeen user_twenty user_twentythree - observeddomainuser
    num__87 num__53 num__74 num__88 num__81 num__66 num__60 num__67 num__73 num__80 num__52 num__59  - num
    str__f str__r str__bh str__cd str__cs str__cr str__v str__u str__alpha str__bo str__bk str__barbara str__cx str__cy str__dl str__e str__william str__bs str__bw str__de str__n str__bp str__cc str__j str__bd str__dg str__robert str__cl str__m str__dm str__james str__michael str__bl str__john str__elizabeth str__df str__z str__cz str__mary str__y str__ce str__bc str__cj str__dn str__bx str__dp str__linda str__bg str__q str__b str__i str__patricia str__jennifer str__david str__cq str__bt str__ck str_two str_three str_five str_six str_eight str_nine str_ten str_twelve str_thirteen str_fifteen str_sixteen str_eighteen str_nineteen str_twentyone str_twentytwo str_twentyfour str_twentyfive str_twentyseven str_twentynine str_thirtyone str_thirtythree str_thirtyfive - string
