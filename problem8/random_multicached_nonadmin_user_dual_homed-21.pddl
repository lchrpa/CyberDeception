...
(:init (PROP_SID user_one str_three) (PROP_USERNAME user_one str_two) (PROP_IS_GROUP user_one no) (PROP_PASSWORD cred_four str_five) (PROP_WINDOWS_DOMAIN dom_six str_seven) (PROP_DNS_DOMAIN dom_six str_eight) (PROP_USER cred_four user_one) (prop_cred user_one cred_four) (PROP_DOMAIN cred_four id_adomain) (PROP_DOMAIN user_one id_adomain) (PROP_DOMAIN cred_four dom_six) (PROP_DOMAIN user_one dom_six) (MEM_CACHED_DOMAIN_CREDS id_dhhost cred_four) (MEM_CACHED_DOMAIN_CREDS id_cfhost cred_four) (MEM_CACHED_DOMAIN_CREDS id_cmhost cred_four)
    (knows id_cmhost)
    (knows id_dorat)
