...
(:domain caldera)
(:objects
    id_bjdomaincredential id_brdomaincredential id_pdomaincredential id_bbdomaincredential id_bfdomaincredential id_ldomaincredential id_bvdomaincredential id_hdomaincredential id_xdomaincredential id_ddomaincredential id_tdomaincredential id_bndomaincredential cred_fortyone cred_fortythree cred_fortyfive cred_fortyseven cred_fortynine - observeddomaincredential
    id_dorat id_durat id_dsrat id_drrat id_dqrat id_dtrat id_dvrat - observedrat
    id_cthost id_dahost id_dhhost id_byhost id_cfhost id_cmhost host_thirteen host_seventeen host_twentyone host_twentyfive - observedhost
    id_efschtask id_ehschtask id_ecschtask id_edschtask id_eeschtask id_egschtask - observedschtask
    id_gdomainuser id_bmdomainuser id_bidomainuser id_badomainuser id_bedomainuser id_budomainuser id_wdomainuser id_sdomainuser id_bqdomainuser id_cdomainuser id_kdomainuser id_odomainuser user_twentynine user_thirtytwo user_thirtyfive user_thirtyeight - observeddomainuser
    num__87 num__53 num__74 num__88 num__81 num__66 num__60 num__67 num__73 num__80 num__52 num__59  - num
    str__f str__r str__bh str__cd str__cs str__cr str__v str__u str__alpha str__bo str__bk str__barbara str__cx str__cy str__dl str__e str__william str__bs str__bw str__de str__n str__bp str__cc str__j str__bd str__dg str__robert str__cl str__m str__dm str__james str__michael str__bl str__john str__elizabeth str__df str__z str__cz str__mary str__y str__ce str__bc str__cj str__dn str__bx str__dp str__linda str__bg str__q str__b str__i str__patricia str__jennifer str__david str__cq str__bt str__ck str_two str_three str_five str_six str_eight str_nine str_eleven str_twelve str_fourteen str_fifteen str_sixteen str_eighteen str_nineteen str_twenty str_twentytwo str_twentythree str_twentyfour str_twentysix str_twentyseven str_twentyeight str_thirty str_thirtyone str_thirtythree str_thirtyfour str_thirtysix str_thirtyseven str_thirtynine str_forty str_fortytwo str_fortyfour str_fortysix str_fortyeight str_fifty - string
...
(:init (PROP_WINDOWS_DOMAIN dom_one str_two) (PROP_DNS_DOMAIN dom_one str_three) (PROP_WINDOWS_DOMAIN dom_four str_five) (PROP_DNS_DOMAIN dom_four str_six) (PROP_WINDOWS_DOMAIN dom_seven str_eight) (PROP_DNS_DOMAIN dom_seven str_nine) (PROP_WINDOWS_DOMAIN dom_ten str_eleven) (PROP_DNS_DOMAIN dom_ten str_twelve) (PROP_DNS_DOMAIN_NAME host_thirteen str_fourteen) (PROP_FQDN host_thirteen str_fifteen) (PROP_DC host_thirteen no) (PROP_HOSTNAME host_thirteen str_sixteen) (PROP_DNS_DOMAIN_NAME host_seventeen str_eighteen) (PROP_FQDN host_seventeen str_nineteen) (PROP_DC host_seventeen no) (PROP_HOSTNAME host_seventeen str_twenty) (PROP_DNS_DOMAIN_NAME host_twentyone str_twentytwo) (PROP_FQDN host_twentyone str_twentythree) (PROP_DC host_twentyone no) (PROP_HOSTNAME host_twentyone str_twentyfour) (PROP_DNS_DOMAIN_NAME host_twentyfive str_twentysix) (PROP_FQDN host_twentyfive str_twentyseven) (PROP_DC host_twentyfive no) (PROP_HOSTNAME host_twentyfive str_twentyeight) (PROP_SID user_twentynine str_thirtyone) (PROP_USERNAME user_twentynine str_thirty) (PROP_IS_GROUP user_twentynine no) (PROP_SID user_thirtytwo str_thirtyfour) (PROP_USERNAME user_thirtytwo str_thirtythree) (PROP_IS_GROUP user_thirtytwo no) (PROP_SID user_thirtyfive str_thirtyseven) (PROP_USERNAME user_thirtyfive str_thirtysix) (PROP_IS_GROUP user_thirtyfive no) (PROP_SID user_thirtyeight str_forty) (PROP_USERNAME user_thirtyeight str_thirtynine) (PROP_IS_GROUP user_thirtyeight no) (PROP_PASSWORD cred_fortyone str_fortytwo) (PROP_PASSWORD cred_fortythree str_fortyfour) (PROP_PASSWORD cred_fortyfive str_fortysix) (PROP_PASSWORD cred_fortyseven str_fortyeight) (PROP_PASSWORD cred_fortynine str_fifty)
    (knows id_cmhost)
    (knows id_dorat)
